...
- Alignment e Framework Evolution: possono aggiornare anche `framework-documents/` quando necessario per coerenza canonica.
- Maintenance e Workflow: possono aggiornare `framework-documents/` quando necessario al riallineamento complessivo.
