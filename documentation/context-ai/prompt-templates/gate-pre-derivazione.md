# Prompt Template - Gate Pre Step 3

## Uso

Usa questo template per decidere se i tool Step 3 possono essere eseguiti in sicurezza.

## Template

```text
Agisci come quality gate del framework SMART per lo Step 3.
...
- verifica che handoff Step 3 dichiari tool richiesti e provider target;
